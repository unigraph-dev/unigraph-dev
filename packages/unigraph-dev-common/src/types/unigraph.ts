...
export interface Unigraph<TT = WebSocket | false> {
     ...
     */
    getSearchResults(query: string, method?: string, display?: string, hops?: number, searchOptions?: {limit?: number, noPrimitives?: boolean}): Promise<{results: any[], entities: any[]}>;
