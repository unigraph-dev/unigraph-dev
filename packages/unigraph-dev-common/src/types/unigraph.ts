...
export interface Unigraph<TT = WebSocket | false> {
     ...
     */
    getSearchResults(query: {method: "fulltext" | "type" | "uid", value: any}[], display?: string, hops?: number, searchOptions?: {limit?: number, noPrimitives?: boolean}): Promise<{results: any[], entities: any[]}>;
