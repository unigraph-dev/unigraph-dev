...
* better delete item logic ([d4cc87b](https://github.com/TheExGenesis/unigraph-dev/commit/d4cc87bfb1639492e91e35e36c1c5a99a995e974))
...
* **data, calendar:** better buildGraph ([a00da79](https://github.com/TheExGenesis/unigraph-dev/commit/a00da793a2c8e5f18daa1edebc2be4e0505300d0))
...
* **electron:** electron build dependencies ([#237](https://github.com/TheExGenesis/unigraph-dev/issues/237)) ([da8128a](https://github.com/TheExGenesis/unigraph-dev/commit/da8128a42db3d7190710968b964f73dee333bf19))
...
* **home:** dynamically update home ([520f537](https://github.com/TheExGenesis/unigraph-dev/commit/520f5377ac499352ddf083ab5ab9b0c24e9cda3f))
...
* modularize inbox view ([f2815e6](https://github.com/TheExGenesis/unigraph-dev/commit/f2815e6941666a1740083de9e05e4a06758da312))
...
* **omnibar:** display issues with mobile and electron ([b431270](https://github.com/TheExGenesis/unigraph-dev/commit/b431270f1b5beeb51162febfca512b133e2f89b3))
...
* **server:** migrate to new timestamp syntax ([b1c4780](https://github.com/TheExGenesis/unigraph-dev/commit/b1c47806f19c0923d1306657f1d58bbc0e477824))
...
* **ux, perf:** summary bar updates and debounced query ([15e5937](https://github.com/TheExGenesis/unigraph-dev/commit/15e593792988b5d2a287cad9fb7e06da91bca9bf))
...
* add capability to search by indexed entries only ([72b525d](https://github.com/TheExGenesis/unigraph-dev/commit/72b525d2930f35406a869a20113a1891b6aa1816))
...
* add math support via katex ([53fb9e4](https://github.com/TheExGenesis/unigraph-dev/commit/53fb9e40fb5b84897091d429590a0edce33eda89))
...
* add union interfaces ([9a8ed98](https://github.com/TheExGenesis/unigraph-dev/commit/9a8ed9811272f45f07359efc190a8e2648f1e036))
...
* better search styles and external namespace ([b2be292](https://github.com/TheExGenesis/unigraph-dev/commit/b2be2926272e86d69a1298b9a5d923f6b1bb8bb7))
...
* **dev:** add current subscriptions view for debug ([35f09fa](https://github.com/TheExGenesis/unigraph-dev/commit/35f09fa1eb2ab8a1272266198b47168180d5a287))
...
* **frontend:** add options to embed bidirectional links in todo/elsewhere ([7024d8c](https://github.com/TheExGenesis/unigraph-dev/commit/7024d8cee2a8be926425a14e86a5dcf64f19ebc1))
...
* items with tag + new home screen ([ec3eacb](https://github.com/TheExGenesis/unigraph-dev/commit/ec3eacb04aca6727b3ee48c55a85cdf48ef137c4))
...
* object editor first pass ([38ad2ae](https://github.com/TheExGenesis/unigraph-dev/commit/38ad2aedae7cb4b90f23ee676599098256ba83e4))
...
* **server:** add hooks for all object created ([bc8848e](https://github.com/TheExGenesis/unigraph-dev/commit/bc8848ed9c23ca6728f9d1317bcfe837b07f8cb3))
...
* upsert for package management ([ea5efca](https://github.com/TheExGenesis/unigraph-dev/commit/ea5efca40da4956eac7f0cd4470dfe0f04642ca4))
* use auto build entities for notes ([8b6626b](https://github.com/TheExGenesis/unigraph-dev/commit/8b6626b09bc8ae3b50d1293ee17e3930378df754))
* use auto dynamic view for all objects ([421d75c](https://github.com/TheExGenesis/unigraph-dev/commit/421d75cd2ed82a872b9ea4d0538b83a291d127ec))
* use infinite scrolling in search ([0d7f46f](https://github.com/TheExGenesis/unigraph-dev/commit/0d7f46f8c5907a09164f219305cbf98609b28396))
* use text formats for schema ([fc9f097](https://github.com/TheExGenesis/unigraph-dev/commit/fc9f097f2b5b2c5e94d4130bf130b0b930b66801))
* user-friendly schema declarations ([edbc3c3](https://github.com/TheExGenesis/unigraph-dev/commit/edbc3c3ffdc10e93dbce78c17b01072d90ab3cf7))
* using union types in semantic properties ([82fcddb](https://github.com/TheExGenesis/unigraph-dev/commit/82fcddb6d8da4b847ba93ad06ad3d9472407762e))
* ux and backlink housekeeping ([f4eb633](https://github.com/TheExGenesis/unigraph-dev/commit/f4eb633db2975a974541622b0f4fce1e5ed6627f))
* ux enhancements ([70740c1](https://github.com/TheExGenesis/unigraph-dev/commit/70740c1768c6560cf3af53487d4c4f7229e84150))
* ux enhancements ([4ce1175](https://github.com/TheExGenesis/unigraph-dev/commit/4ce117558f8acb3376bf2930dd7e229d35a66d6d))
* ux updates ([ef3424d](https://github.com/TheExGenesis/unigraph-dev/commit/ef3424dfdde9ed6354c60ffb17626e313edf1e31))
* various ux enhancements ([26dce95](https://github.com/TheExGenesis/unigraph-dev/commit/26dce95d7015eab9ad2539c0ac67937917b0306e))
* **various:** various workspace ux fixes ([6e7144c](https://github.com/TheExGenesis/unigraph-dev/commit/6e7144cfe32fa5c6b12bab716cde2bccc173d023))
* view items in object editor ([f5ca485](https://github.com/TheExGenesis/unigraph-dev/commit/f5ca485f5355e4b2a3b6389fb2d91325ddec87ad))
* workspace first pass ([8956676](https://github.com/TheExGenesis/unigraph-dev/commit/895667692650ebdbc4ff793d45d46328bff16ad6))


### Performance Improvements

* better insert performance ([de8fdfe](https://github.com/TheExGenesis/unigraph-dev/commit/de8fdfeae1b38d42e498392058cd446e889ba760))
* big list rendering with virtualized list ([446a51f](https://github.com/TheExGenesis/unigraph-dev/commit/446a51ff0b010147941a8f30065e1fb68d287cca))
* big query performances & support for lots of rss feed ([545d1b2](https://github.com/TheExGenesis/unigraph-dev/commit/545d1b23e0c75e0ef7e431b72404a68510bd2149))
* **data:** reduce queries to dgraph to speed up ([715a102](https://github.com/TheExGenesis/unigraph-dev/commit/715a10238c2f195af569bd3af229c6fa72098cf7))
* **feed:** 100x increase bulk ingestion performance ([bf596ee](https://github.com/TheExGenesis/unigraph-dev/commit/bf596eef172845c478583b3260941461ba160a62))
...
* **frontend:** optimize layout renderer efficiency ([f979e4f](https://github.com/TheExGenesis/unigraph-dev/commit/f979e4ff83d3d7fe3dc2c5f64111f987fee85af3))
* general performance enhancements ([b5d7b11](https://github.com/TheExGenesis/unigraph-dev/commit/b5d7b11e73c4fcc4c7db87bbf0c048bb75b5679d))
* inbox directly deletes objects ([663f397](https://github.com/TheExGenesis/unigraph-dev/commit/663f397aebd7f64f129fd9a80a338db135bdf36a))
* infinite scrolling list for arbitrarily large lists ([85653bc](https://github.com/TheExGenesis/unigraph-dev/commit/85653bc47b26ccb76fcf538f4011fd2b18e8b3f0))
* optimized schema-based on-demand queries for performance ([bea07ad](https://github.com/TheExGenesis/unigraph-dev/commit/bea07ad6e945d98511f8e26f1240208625d1616c))
* poll subscriptions separately ([a65ecde](https://github.com/TheExGenesis/unigraph-dev/commit/a65ecdec99501c65daf38b0506b9cca7d26a6b7a))
* remove duplicate updates with stable stringify ([aa85426](https://github.com/TheExGenesis/unigraph-dev/commit/aa8542677d0824d22704e5a797926b3913520aeb))
* **server:** schema refresh query speedup ([c40903f](https://github.com/TheExGenesis/unigraph-dev/commit/c40903f1d76f0d1331660e35a5e4b477e018e4e4))
