...
const List = React.useMemo(() => {
    return ({column}) => {
        ...
        return <Card style={{width: "360px", minWidth: "360px", padding: "12px", margin: "8px", height: "100%", overflow: "auto"}} variant="outlined" >
...
return <div style={{padding: "24px", overflow: "auto", ...(data?._backgroundImage ? {backgroundImage: `url(${data?._backgroundImage})`, backgroundSize: "cover"}: {}), height: "100%", width: "100%"}}>
