...
export function TodayView({ pageName }: any) {
    ...
    return (
        <div style={{ display: 'flex', height: '100%', width: '100%' }}>
            <div style={{
                maxWidth: '33%', minWidth: '33%', padding: '8px 16px 16px 8px', display: 'flex', height: '100%', flexDirection: 'column', flexGrow: 1,
            }}
            >
            ...
            <div style={{
                flexGrow: 1, padding: '8px 16px 16px 8px', display: 'flex', flexDirection: 'column', opacity: showInboxes ? 1 : 0,
            }}
            >
