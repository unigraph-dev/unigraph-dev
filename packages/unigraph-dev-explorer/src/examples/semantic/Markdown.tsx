                    ...
                    if (className?.includes('wikilink')) {
                        ...
                        return (
                            <>
                                ...
                                {objDef ? (
                                    <div style={{
                                        display: 'inline-flex', minWidth: '16px', minHeight: '15px', backgroundImage: `url("data:image/svg+xml,${objDef?._icon}")`, opacity: 0.54,
                                    }}
                                    />
                                ) : []}
                                ...
                                {React.createElement('span', {
                                    ...
                                    style: {
                                        display: 'contents',
                                        color: (matches[0] || callbacks?.namespaceLink) ? 'mediumblue' : 'black',
                                        ':hover': {
