...
const Column = ({name, children}: any) => {
...
export const SubscriptionsView = () => {
    ...
    return <div>
        <Typography>{subs.length} Subscriptions</Typography>
        {subs.map(el => <Card style={{margin: "12px", padding: "12px"}} variant="outlined">
            ...
            <Column name="From connection / client"><Typography>{el.connId} / {el.clientId}</Typography></Column>
