...
export const ObjectOverview = ({data}: any) => {
    return <div>
        ...
        <span style={{display: 'flex', alignItems: "center"}}><Icon path={mdiTimelineClockOutline} size={1} style={{margin: "4px"}}/><Typography>{new Date(data._updatedAt).toLocaleString()}</Typography></span>
    </div>
}