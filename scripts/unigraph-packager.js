...
const declObject = {
    pkgManifest: {
        ...
        package_name: packageJson.unigraph.package_name,
        version: packageJson.version,
        description: packageJson.description,
    },
    pkgSchemas: Object.fromEntries(schemasDecl.map(el => [el.id, JSON.parse(getFileContent(el.src))])),
    pkgExecutables: Object.fromEntries(executablesDecl.map(el => [el.id, {
        ...el,
        id: undefined,
...
fs.writeFileSync(path.join(outDir, `${packageJson.unigraph.package_name}.pkg.js`), finalPackage)